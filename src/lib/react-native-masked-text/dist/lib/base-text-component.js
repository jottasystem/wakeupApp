...
var _maskResolver = require("./mask-resolver");
var _maskResolver2 = _interopRequireDefault(_maskResolver);
...
var BaseTextComponent = (function(_Component) {
  ...
  function BaseTextComponent(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (BaseTextComponent.__proto__ || Object.getPrototypeOf(BaseTextComponent)).call(this, props)
    );
    _this.state = { type: props.type, value: "", options: null };
  ...
  _createClass(BaseTextComponent, [
      ...
      value: function updateValue(text) {
        ...
        return new Promise(function(resolve, reject) {
          ...
          if (self._mustUpdateValue(maskedText)) {
            self.setState({ value: maskedText }, function() {
              resolve(maskedText);
            });
          } else {
    ...
    },
    {
      ...
      value: function _bindProps(props) {
        ...
        self.setState({ type: props.type, options: props.options }, function() {
